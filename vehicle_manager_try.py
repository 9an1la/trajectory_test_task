...
class Vehicle:
    def __init__(self, vehicle_id, name, model, year, color, price, latitude, longitude):
...
class VehicleManager:
    ...
    def get_vehicles(self):
        ...
        for vehicle_data in vehicles_data:
            vehicle = self.create_vehicle_from_data(vehicle_data)
    ...
    def create_vehicle_from_data(self, vehicle_data):
        vehicle = Vehicle(vehicle_data['id'], vehicle_data['name'],
